<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GuestPage.aspx.vb" Inherits="GuestPage" %>
                            ...
                            <div class="booking-left">
                                <asp:UpdatePanel ID="up1" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <asp:DataList ID="dlPersonalInfo" Width="100%" runat="server">
                                            ...
                                            <ItemTemplate>
                                                <div style="padding-bottom: 0px;">
                                                  ...
                                                  <asp:Label ID="lblGuestType" Text='<%# Eval("GuestType") %>' Visible="false" runat="server"></asp:Label>
                                                  <asp:Label ID="lblType" Text='<%# Eval("Type") %>' style="display:none" runat="server"></asp:Label>
                                                </div>
                                                <div>
                                        ...
                                        <div class="guest-form-i-a" style="margin-top:10px">
                                        ...
                                        <div>
                                            <div class="booking-form">
                                                ...
                                                <div class="booking-form-i-a" runat="server" id="dvColumbusReference">
                                                    <label runat="server" id="lblOldBookingNo">
                                                        Old Booking No (RPT/RGT):</label>
                                                    <div class="input">
                                                        <asp:TextBox ID="txtColumbusReference" runat="server"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="clear">
                                            ...
                                            <div class="booking-form" id="divsubmit" runat ="server">
                                                ...
                                                <div class="booking-form-i-a">
                                                    <asp:Button ID="btnSubmitBooking" class="authorize-btn" Width="200px" runat="server"
                                                ...
                                                <div id="divprintbook" runat ="server" class="booking-form-i-a" style="display:none">
                                                    <asp:Button ID="btnprint" class="authorize-btn" Width="200px"  runat="server"
                                                        Text="Print Booking" />
                                                </div>
                                                <div id="divnewbook" runat ="server" class="booking-form-i-a" style="display:none">
                                                    <asp:Button ID="btnnewbooking" class="authorize-btn" Width="200px"  runat="server"
                                                        Text="New Booking" />
                                                </div>
                                                 <div id="divabondon" runat ="server" class="booking-form-i-a">
                                                    <asp:Button ID="btnAbondon" class="authorize-btn" Width="200px" runat="server"
                    ...
                    <div id="Div24" class="roomtype-price-breakuppopup" style="max-height: 500px; overflow: auto">
                        <div id="dvAirPartyRemarks" runat="server">
                            <div id="Div25" runat="server" style="border: 1px solid #fff; width: 700px; height: 30px;
                                ...
                                <asp:Label ID="lblAirPartyRemarks" CssClass="room-type-breakup-headings" Text="Supplier Remarks"
                                    runat="server"></asp:Label>
                            </div>
                        ...
                        <div id="Div27" runat="server" style="border: 1px solid #fff; width: 700px; height: 30px;
                            background-color: #ede7e1; padding-right: 5px; padding-left: 5px; margin-right: 10px;
                            text-align: left; vertical-align: middle; padding-top: 10px;">
                            <asp:Label ID="lblAirCustRemarks" CssClass="room-type-breakup-headings" Text="Customer Remarks"
                                runat="server"> </asp:Label>
                        </div>
                        ...
                        <div id="dvAirArrRemarks" runat="server">
                            <div style="border: 1px solid #fff; width: 700px; height: 30px; background-color: #ede7e1;
                                ...
                                <asp:Label ID="lblAirArrRemarks" CssClass="room-type-breakup-headings" Text="Arrival Remarks"
                                    runat="server"> </asp:Label>
                            </div>
                            <div style="padding-left: 10px; padding-top: 10px; margin-bottom: 0px;">
                                <div class="booking-form">
                        ...
                        <div id="dvAirdeptremarks" runat="server">
                            <div style="border: 1px solid #fff; width: 700px; height: 30px; background-color: #ede7e1;
                                padding-right: 5px; padding-left: 5px; margin-right: 10px; text-align: left;
                                vertical-align: middle; padding-top: 10px;">
                                <asp:Label ID="lblAirdeptRemarks" CssClass="room-type-breakup-headings" Text="Departure Remarks"
                                    runat="server"> </asp:Label>
                            </div>
                            <div style="padding-left: 10px; padding-top: 10px; margin-bottom: 0px;">
                                <div class="booking-form">
                    ...
                    <div id="Div21" class="roomtype-price-breakuppopup" style="max-height: 500px; overflow: auto">
                        <div id="dvTrfsPartyRemarks" runat="server">
                            <div id="Div22" runat="server" style="border: 1px solid #fff; width: 700px; height: 30px;
                                background-color: #ede7e1; padding-right: 5px; padding-left: 5px; margin-right: 10px;
                                text-align: left; vertical-align: middle; padding-top: 10px;">
                                <asp:Label ID="lblTrfsPartyRemarks" CssClass="room-type-breakup-headings" Text="Supplier Remarks"
                                    runat="server"></asp:Label>
                            </div>
                        ...
                        <div id="Div29" runat="server" style="border: 1px solid #fff; width: 700px; height: 30px;
                            background-color: #ede7e1; padding-right: 5px; padding-left: 5px; margin-right: 10px;
                            text-align: left; vertical-align: middle; padding-top: 10px;">
                            <asp:Label ID="lblTrfsCustRemarks" CssClass="room-type-breakup-headings" Text="Customer Remarks"
                                runat="server"> </asp:Label>
                        </div>
                        <div style="padding-left: 10px; padding-top: 10px; margin-bottom: 0px;">
                            <div class="booking-form">
                        ...
                        <div id="dvtrfsArrRemarks" runat="server" runat="server">
                            <div style="border: 1px solid #fff; width: 700px; height: 30px; background-color: #ede7e1;
                                padding-right: 5px; padding-left: 5px; margin-right: 10px; text-align: left;
                                vertical-align: middle; padding-top: 10px;">
                                <asp:Label ID="lbltrfsArrRemarks" CssClass="room-type-breakup-headings" Text="Arrival Remarks"
                                    runat="server"> </asp:Label>
                            </div>
                            <div style="padding-left: 10px; padding-top: 10px; margin-bottom: 0px;">
                                <div class="booking-form">
                        ...
                        <div id="dvtrfsDeptRemarks" runat="server">
                            <div style="border: 1px solid #fff; width: 700px; height: 30px; background-color: #ede7e1;
                                padding-right: 5px; padding-left: 5px; margin-right: 10px; text-align: left;
                                vertical-align: middle; padding-top: 10px;">
                                <asp:Label ID="lblTrfsDeptRemarks" CssClass="room-type-breakup-headings" Text="Departure Remarks"
                                    runat="server"> </asp:Label>
                            </div>
                            <div style="padding-left: 10px; padding-top: 10px; margin-bottom: 0px;">
                                <div class="booking-form">
                    ...
                    <div class="roomtype-price-breakuppopup" style="max-height: 500px; overflow: auto">
                        <div id="dvOthPartyRemarks" runat="server">
                            <div style="border: 1px solid #fff; width: 700px; height: 30px; background-color: #ede7e1;
                                padding-right: 5px; padding-left: 5px; margin-right: 10px; text-align: left;
                                vertical-align: middle; padding-top: 10px;">
                                <asp:Label ID="lblOthPartyRemarks" CssClass="room-type-breakup-headings" Text="Supplier Remarks"
                                    runat="server"></asp:Label>
                            </div>
                        ...
                        <div style="border: 1px solid #fff; width: 700px; height: 30px; background-color: #ede7e1;
                            padding-right: 5px; padding-left: 5px; margin-right: 10px; text-align: left;
                            vertical-align: middle; padding-top: 10px;">
                            <asp:Label ID="lblOthCustRemarks" CssClass="room-type-breakup-headings" Text="Customer Remarks"
                                runat="server"> </asp:Label>
                        </div>
                        <div style="padding-left: 10px; padding-top: 10px; margin-bottom: 0px;">
                            <div class="booking-form">
                        ...
                        <div id="dvOthArrRemarks" runat="server">
                            <div style="border: 1px solid #fff; width: 700px; height: 30px; background-color: #ede7e1;
                                padding-right: 5px; padding-left: 5px; margin-right: 10px; text-align: left;
                                vertical-align: middle; padding-top: 10px;">
                                <asp:Label ID="lblOthArrRemarks" CssClass="room-type-breakup-headings" Text="Arrival Remarks"
                                    runat="server"> </asp:Label>
                            </div>
                            <div style="padding-left: 10px; padding-top: 10px; margin-bottom: 0px;">
                                <div class="booking-form">
                        ...
                        <div id="dvOthdeptremarks" runat="server">
                            <div style="border: 1px solid #fff; width: 700px; height: 30px; background-color: #ede7e1;
                                padding-right: 5px; padding-left: 5px; margin-right: 10px; text-align: left;
                                vertical-align: middle; padding-top: 10px;">
                                <asp:Label ID="lblOthDeptRemarks" CssClass="room-type-breakup-headings" Text="Departure Remarks"
                                    runat="server"> </asp:Label>
                            </div>
                            <div style="padding-left: 10px; padding-top: 10px; margin-bottom: 0px;">
                                <div class="booking-form">
            ...
            <div id="Div30" class="roomtype-price-breakuppopup" style="float: left; text-align: left;
                ...
                <div align="left" id="Div31">
                    ...
                    <div id="Div36" runat="server" style="border: 1px solid #fff; width: 700px; height: 30px;
                        background-color: #ede7e1; padding-right: 5px; padding-left: 5px; margin-right: 10px;
                        text-align: left; vertical-align: middle; padding-top: 10px;">
                        <asp:Label ID="lblVisaAgentRemarks" CssClass="room-type-breakup-headings" Text="Customer Remarks"
                            runat="server"> </asp:Label>
                    </div>
                    <div style="padding-left: 10px; padding-top: 10px; margin-bottom: 0px;">
                        <div class="booking-form">
                    ...
                    <div id="dvvisaarrivalrem" runat="server">
                        <div style="border: 1px solid #fff; width: 700px; height: 30px; background-color: #ede7e1;
                            padding-right: 5px; padding-left: 5px; margin-right: 10px; text-align: left;
                            vertical-align: middle; padding-top: 10px;">
                            <asp:Label ID="lblvisaarrremarks" CssClass="room-type-breakup-headings" Text="Arrival Remarks"
                                runat="server"> </asp:Label>
                        </div>
                        <div style="padding-left: 10px; padding-top: 10px; margin-bottom: 0px;">
                            <div class="booking-form">
                    ...
                    <div class="roomtype-price-breakuppopup" style="max-height: 500px; overflow: auto">
                        <div id="dvToursPartyRemarks" runat="server">
                            <div id="Div13" runat="server" style="border: 1px solid #fff; width: 700px; height: 30px; background-color: #ede7e1;
                                ...
                                <asp:Label ID="lblToursheading" CssClass="room-type-breakup-headings" Text="Supplier Remarks"
                                    runat="server"></asp:Label>
                            </div>
                            <div style="padding-left: 10px; padding-top: 2px; margin-bottom: 0px;">
                                <div class="booking-form">
                        ...
                        <div id="dvToursCustRemarks" runat="server" style="border: 1px solid #fff; width: 700px;
                            ...
                            <asp:Label ID="lblToursCustRemarks" CssClass="room-type-breakup-headings" Text="Customer Remarks"
                                runat="server"> </asp:Label>
                        </div>
                        <div style="padding-left: 10px; padding-top: 10px; margin-bottom: 0px;">
                            <div class="booking-form">
                        ...
                        <div id="dvToursArrRemarks" runat="server">
                            <div style="border: 1px solid #fff; width: 700px; height: 30px; background-color: #ede7e1;
                                padding-right: 5px; padding-left: 5px; margin-right: 10px; text-align: left;
                                vertical-align: middle; padding-top: 10px;">
                                <asp:Label ID="lblToursArrRemarks" CssClass="room-type-breakup-headings" Text="Arrival Remarks"
                                    runat="server"> </asp:Label>
                            </div>
                        ...
                        <div id="dvToursDeptRemarks" runat="server">
                            <div style="border: 1px solid #fff; width: 700px; height: 30px; background-color: #ede7e1;
                                padding-right: 5px; padding-left: 5px; margin-right: 10px; text-align: left;
                                vertical-align: middle; padding-top: 10px;">
                                <asp:Label ID="lblToursDeptRemarks" CssClass="room-type-breakup-headings" Text="Departure Remarks"
                                    runat="server"> </asp:Label>
                            </div>
                            <div style="padding-left: 10px; padding-top: 10px; margin-bottom: 0px;">
                                <div class="booking-form">
                    ...
                    <div align="left" id="Div5">
                        ...
                        <div id="Div2" class="roomtype-price-breakuppopup" style="max-height: 500px; overflow: auto">
                            ...
                            <div id="dvCustRemarks" runat="server" style="border: 1px solid #fff; width: 700px;
                                height: 30px; background-color: #ede7e1; padding-right: 5px; padding-left: 5px;
                                margin-right: 10px; text-align: left; vertical-align: middle; padding-top: 10px;">
                                <asp:Label ID="lblCustRemarks" CssClass="room-type-breakup-headings" Text="Customer Remarks"
                                    runat="server"> </asp:Label>
                            </div>
                            <div style="padding-left: 10px; padding-top: 10px; margin-bottom: 0px;">
                                <div class="booking-form">
                            ...
                            <div id="dvArrRemarks" runat="server">
                                <div style="border: 1px solid #fff; width: 700px; height: 30px; background-color: #ede7e1;
                                    padding-right: 5px; padding-left: 5px; margin-right: 10px; text-align: left;
                                    vertical-align: middle; padding-top: 10px;">
                                    <asp:Label ID="lblArrRemarks" CssClass="room-type-breakup-headings" Text="Arrival Remarks"
                                        runat="server"> </asp:Label>
                                </div>
                            ...
                            <div id="dvDepRemarks" runat="server">
                                <div style="border: 1px solid #fff; width: 700px; height: 30px; background-color: #ede7e1;
                                    padding-right: 5px; padding-left: 5px; margin-right: 10px; text-align: left;
                                    vertical-align: middle; padding-top: 10px;">
                                    <asp:Label ID="lblDeptRemarks" CssClass="room-type-breakup-headings" Text="Departure Remarks"
                                        runat="server"> </asp:Label>
                                </div>
                                <div style="padding-left: 10px; padding-top: 10px; margin-bottom: 0px;">
                                    <div class="booking-form">
