...
Public Class DALTransferFreeFormBooking
    ...
    Function GetTransferDatas(strRequestId As String, strRlineNo As String, strMode As String) As Data.DataTable
        Try

            Dim ProcName As String
            ProcName = "sp_fill_transfer_freeform"
        ...
        Catch ex As Exception
            objclsUtilities.WriteErrorLog("DALTransferFreeFormBooking:: " & Reflection.MethodBase.GetCurrentMethod.Name & " :: " & ex.Message.ToString)
            Return Nothing
        End Try
    End Function

    Function SaveTransferFreeFormBooking() As String
        ...
        Try
            ...
            Dim ProcName As String
            ProcName = "sp_save_freeformbooking_transfer"
            ...
            parm(10) = New SqlParameter("@tlinenostring", CType(RlineNos, String))
            sqlParamList.Add(parm(10))
            parm(11) = New SqlParameter("@transferxml", CType(TransferXml, String))
