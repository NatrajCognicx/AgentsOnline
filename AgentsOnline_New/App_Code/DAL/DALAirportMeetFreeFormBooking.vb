...
Public Class DALAirportMeetFreeFormBooking
    ...
    Function GetAirportMeetDatas(strRequestId As String, strRlineNo As String, strMode As String) As Data.DataTable
        Try

            Dim ProcName As String
            ProcName = "sp_fill_airport_freeform"
            Dim parm(2) As SqlParameter
            parm(0) = New SqlParameter("@requestid", CType(strRequestId, String))
            parm(1) = New SqlParameter("@tlineno", CType(strRlineNo, String))
            parm(2) = New SqlParameter("@Mode", CType(strMode, String))
            Dim dt As New DataTable
            dt = objclsUtilities.GetDataTable(ProcName, parm)
            Return dt

        Catch ex As Exception
            objclsUtilities.WriteErrorLog("DALAirportMeetFreeFormBooking:: " & Reflection.MethodBase.GetCurrentMethod.Name & " :: " & ex.Message.ToString)
            Return Nothing
        End Try
    End Function

    Function SaveAirportMeetFreeFormBooking() As String
        ...
        Try
            ...
            Dim ProcName As String
            ProcName = "sp_save_freeformbooking_AirportMeet"
            ...
            parm(10) = New SqlParameter("@alinenostring", CType(RlineNos, String))
            sqlParamList.Add(parm(10))
            parm(11) = New SqlParameter("@AirportMeetxml", CType(AirportMeetXml, String))
