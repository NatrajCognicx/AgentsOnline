...
Public Class clsUtilities
    ...
    Public Sub WriteErrorLog(ByVal StrMsgText As String)
        ...
        End Try
    End Sub
    Public Sub WriteAPILog(ByVal StrMsgText As String, ByVal StrAPIName As String, ByVal StrType As String)
        Try
            Dim SW As StreamWriter
            Dim StrErrTime As String = ""
            Dim StrFileName As String = ""
            Dim dToday As DateTime = System.DateTime.Now
            StrFileName = Path & "APILog_" & StrAPIName & StrType & "_" & Format(dToday.Year, "0000") & Format(dToday.Month, "00") & Format(dToday.Day, "00") & Format(dToday.Hour, "00") & Format(dToday.Minute, "00") & Format(dToday.Second, "00") & Format(dToday.Millisecond, "00") & ".SV"
            If Not Directory.Exists(Path) Then
                Directory.CreateDirectory(Path)
            End If
            StrErrTime = Format(DateTime.Now) ' & ":" & Format(Now.Hour, "00") & ":" & Format(Now.Minute, "00") & ":" & Format(Now.Second, "00")
    ...
    Sub LoadTheme(ByVal strCompany As String, ByVal htmlLink As HtmlLink)
        If Not strCompany Is Nothing Then
            ...
            ElseIf strCompany = "675558760549078" Then 'AgentsOnlineCommon1
                htmlLink.Attributes("href") = "css/style-style3.css"
            Else
