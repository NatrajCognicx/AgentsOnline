...
Public Class BLLTourFreeFormBooking
    ...
    Dim objDALTourFreeForm As New DALTourFreeForm
    ...
    Function SaveTourFreeFormTemp() As Boolean
        Dim result As Boolean

        objDALTourFreeForm.SubUserCode = SubUserCode
        result = objDALTourFreeForm.InsertTourFreeFormBookingInTemp(EBdiv_code, AgentCode, EBsourcectrycode, EBreqoverride, EbRequestID, EBagentref, EBcolumbusref, EBremarks, EBToursXml, EBuserlogged, RowLineNo, SectorgroupCode, OpMode, BufferMultiCostBreakup, BufferComboBreakup)
        Return result
    ...
    Function GetTourFreeFormBookingfromTemp(ByVal strRequestId As String, ByVal OLineNo As String) As DataSet
        ...
        ds = objDALTourFreeForm.GetTourFreeFormBookingfromTemp(strRequestId, OLineNo)
        Return ds
    End Function
    ...
    '    Dim dt As DataTable
    '    dt = objDALTourSearch.GetBookedComboMultiDateDetails(strrequestid, excCode, Type)
    '    Return dt
    'End Function
