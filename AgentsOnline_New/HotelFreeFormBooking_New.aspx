<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HotelFreeFormBooking_New.aspx.vb" Inherits="HotelFreeFormBooking_New" %>
                 ...
                 <%--<asp:UpdatePanel ID="UpdatePanel5" runat="server"><ContentTemplate>--%>
                                       ...
                                       <div class="search-large-i" >
                                        ...
                                        <div class="clear">
                                                           ...
                                                           <asp:UpdatePanel ID="UpdatePanel5" runat="server"> <%-- *** 15/02/2020 Abin Dynamic Adult and Chhild numbers--%> 
                                            <ContentTemplate>
                                                ...
                                                <div class="srch-tab-line no-margin-bottom">
                                                        ...
                                                        <div style="width: 100%">
                                                            <label>
                                                               Room <%# Eval("colChildLbl") %> Accomodation Type</label>
                                                            <div class="input-a">
                                                                <asp:TextBox ID="txtRoomAccomodationType" runat="server" placeholder="--"></asp:TextBox>
                                                                <asp:TextBox ID="txtRoomAccomodationTypeCode" runat="server" Style="display: none;"></asp:TextBox>
                                                                <asp:AutoCompleteExtender ID="AutoCompleteExtenderRoomAccomodationType" runat="server"
                                                                    CompletionInterval="10" CompletionListCssClass="autocomplete_completionListElement_register"
                                                                    CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem_register"
                                                                    CompletionListItemCssClass="autocomplete_listItem_register" CompletionSetCount="1"
                                                                    DelimiterCharacters="" EnableCaching="false" Enabled="True" FirstRowSelected="True"
                                                                    MinimumPrefixLength="-1" TargetControlID="txtRoomAccomodationType" UseContextKey="true"
                                                                    ServiceMethod="GetAccomodationType" OnClientItemSelected="RoomAccomodationTypeautocompleteselected"
                                                                    OnClientPopulating="AutoCompleteExtenderRoomAccomodationType_OnClientPopulating">
                                                    ...
                                                    <div class="srch-tab-right">
                                                        <div style="width: 100%">
                                                            <label>
                                                               Room <%# Eval("colChildLbl") %> Accomodation</label>
                                                            <div class="input-a">
                                                                <asp:TextBox ID="txtRoomAccomodation" runat="server" placeholder="--"></asp:TextBox>
                                                                <asp:TextBox ID="txtRoomAccomodationCode" runat="server" Style="display: none;"></asp:TextBox>
                                                                <asp:AutoCompleteExtender ID="AutoCompleteExtendertxtRoomAccomodation" runat="server"
                                                                    CompletionInterval="10" CompletionListCssClass="autocomplete_completionListElement_register"
                                                                    CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem_register"
                                                                    CompletionListItemCssClass="autocomplete_listItem_register" CompletionSetCount="1"
                                                                    DelimiterCharacters="" EnableCaching="false" Enabled="True" FirstRowSelected="True"
                                                                    MinimumPrefixLength="-1" TargetControlID="txtRoomAccomodation" UseContextKey="true"
                                                                    ServiceMethod="GetAccomodation"  OnClientItemSelected="RoomAccomodationautocompleteselected">
                                                                </asp:AutoCompleteExtender>
                                                            </div>
                                                        </div>
                                                    </div>
