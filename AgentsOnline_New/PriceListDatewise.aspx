<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PriceListDatewise.aspx.vb" Inherits="PriceListDatewise" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Mohd Al Humaidi Computer Services L.L.C.</title>
...
<%--    <link href='http://fonts.googleapis.com/css?family=Montserrat:400,700' rel='stylesheet'
    ...
    <script language="javascript" type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#ddlHotelNames').multiselect({
                includeSelectAllOption: true,
                buttonWidth: 250,
                enableFiltering: true
            });

            $('#ddlHotelNames').change(function () {
                $('#txtHotelCode').val($('#ddlHotelNames').val());
            });
    ...
    <script type="text/javascript">
        ...
        function ValidateSearch() {
            if ((document.getElementById('<%=txtHotelCode.ClientID%>').value == '') && (document.getElementById('<%=txtDestinationCode.ClientID%>').value == '')) {
                showDialog('Alert Message', 'Please select any DESTINATION/LOCATION / HOTEL NAME.', 'warning');
                return false;
            }
            if ((document.getElementById('<%=txtHotelCode.ClientID%>').value == '') && (document.getElementById('<%=txtDestinationCode.ClientID%>').value != '') && (document.getElementById('<%=txtHotelStarscode.ClientID%>').value == '')) {
                showDialog('Alert Message', 'Please select any STAR CATEGORY / HOTEL.', 'warning');
                return false;
            }
        ...
        function GetHotelsList(contxt) {
                    
//                        $.ajax({
//                            type: "POST",
//                            url: "PriceListDatewise.aspx/GetHotelsList",
//                            data: '{contxt:  "' + contxt + '"}',
//                            contentType: "application/json; charset=utf-8",
//                            dataType: "json",
//                            success: OnSuccessHotelList,
//                            failure: function (response) {
//                                alert('failure');
//                                alert(response.d);
//                            },
...
//                        });
        ...
        function OnSuccessHotelList(response) {
...
//            });
    ...
    <script language="javascript" type="text/javascript">
        ...
        function DestAutoCompleteExtenderKeyUp() {
        ...
        function AutoCompleteExtender_HotelStarsKeyUpNew() {
            ...
            <div class="wrapper-padding-full">
                <div class="page-head">
                    <div class="page-title">
                       BEST RATE DAY WISE<span></span></div>
                    <div class="clear">
                    </div>
                </div>
                <div class="page-head">
                    <div class="page-search-content-search" style="margin-top: -10px;">
                        <div class="search-tab-content" style="min-height: 300px; max-height:400px; padding-left: 55px;
                            padding-top: 15px;">
                            <asp:updatepanel id="upnlSearch" runat="server" >
                                <contenttemplate>                         
                                   <div class="page-search-p">
                         <!-- // -->
                                       <div class="row-col-3" style="padding-left:25px; padding-top: 20px">
                                       ...
                                       <div class="row-col-3" style="padding-left:25px; padding-top: 20px">
                                           <div class="srch-tab-line no-margin-bottom">
                                               <label>
                                                   Destination/Location<i class="fa fa-star" style="font-size: 6px; color: red; position: absolute;">
                                                   </i>
                                               </label>
                                               <div class="input-a">
                                                   <asp:TextBox ID="txtDestinationName" onkeyup="DestAutoCompleteExtenderKeyUp()" runat="server" placeholder="Example: dubai"></asp:TextBox>
                                       ...
                                       <div class="row-col-3" style="padding-left:25px; padding-top: 20px">
                                           ...
                                           <div class="srch-tab-line no-margin-bottom">
                                               ...
                                               <label>
                                                   Star Category</label>
                                               <div class="input-a">
                                                   <asp:TextBox ID="txtHotelStars" onkeyup="AutoCompleteExtender_HotelStarsKeyUpNew()" runat="server" placeholder="--"></asp:TextBox>
                                       ...
                                       <div class="row-col-3" style="padding-left:25px;padding-top: 20px">
                                           ...
                                           <div class="srch-tab-line no-margin-bottom"   >
                                               <label>
                                                   Hotel Name</label>
                                                      ...
                                                      <asp:DropDownList ID="ddlHotelNames" runat="server" multiple="multiple" style="width:80px">
                                                        </asp:DropDownList>
                                               <div  >
                                                   <asp:TextBox ID="txtHotelName" Style="display: none;" runat="server" placeholder="--"></asp:TextBox>
                                        ...
                                        <div class="row-col-3" style="padding-left:25px;padding-top: 20px">
                                           ...
                                           <div class="select-wrapper">
                                                   <asp:DropDownList ID="ddlRoomClass" runat="server" CssClass="custom-select custom-select-ddlOrderBy">
                                       ...
                                       <div class="clear"></div>
                                        ...
                                        <div class="row-col-3" style="padding-left:25px;padding-top: 20px">
                                           ...
                                           <div class="srch-tab-line no-margin-bottom">
                                               <label>
                                                   Offer type</label>
                                               <div class="select-wrapper">
                                                   <asp:DropDownList ID="ddlOfferType" runat="server" CssClass="custom-select custom-select-ddlOrderBy">
                                        ...
                                        <div class="row-col-3" style="padding-left:25px;padding-top: 20px">
                                           ...
                                           <div class="srch-tab-line no-margin-bottom">
                                               ...
                                               <div class="select-wrapper">
                                                   <asp:DropDownList ID="ddlOccupancy" runat="server" CssClass="custom-select custom-select-ddlOrderBy">
                                                       <asp:ListItem Value="DBL">DBL</asp:ListItem>
                                                       <asp:ListItem>SGL</asp:ListItem>
                                         ...
                                         <div class="row-col-3" style="padding-left:25px;padding-top: 20px">
                                           ...
                                           <div class="srch-tab-line no-margin-bottom">
                                               <label>
                                                   Rate Type</label>
                                               <div class="select-wrapper">
                                                   <asp:DropDownList ID="ddlRateType" runat="server" CssClass="custom-select custom-select-ddlOrderBy">
                                                    
                                                       <asp:ListItem Value="Net Payable">Net Payable</asp:ListItem>
                                                         <asp:ListItem Value="Selling Rates">Selling Rates</asp:ListItem>
                                                   </asp:DropDownList>
                                               </div>
                                           </div>
                                           <!-- \\ -->
                                          ...
                                          <div class="row-col-2" style="padding-left:25px; padding-top: 20px;display:none;">
                                           <div class="srch-tab-line no-margin-bottom">
                            ...
                            <div class="row-col-1" style="padding-top:20px;">
                             ...
                             <div class="clear">
                                 <asp:GridView ID="gvHeading" runat="server" AutoGenerateColumns="False" 
                                     ShowHeader="False">
                                     <Columns>
                                         <asp:BoundField DataField="1" ShowHeader="False" />
                                         <asp:BoundField DataField="2" ShowHeader="False" />
                                     </Columns>
                                     <FooterStyle Height="25px" />
                                 </asp:GridView>
                             </div>     
                     
                                     <asp:GridView ID="GridView1" HeaderStyle-BackColor="#2E86C1" HeaderStyle-ForeColor="White" HeaderStyle-Height="40px"
    RowStyle-BackColor="White" AlternatingRowStyle-BackColor="White" AlternatingRowStyle-ForeColor="#000"
    runat="server" >
   
                              
                              
                                 <HeaderStyle BackColor="#2E86C1" ForeColor="White" />
                                 <RowStyle BackColor="White" />
   
</asp:GridView> 
                             <div class="clear">
                            </div>                    
                             <div class="row-col-1" style="padding-right:40px;padding-left:25px; padding-top:20px">
                                <asp:Button ID="btnSearch" class="authorize-btn"  OnClientClick="return ValidateSearch()" runat="server" Text="Load Report"></asp:Button>                                       
                             </div>
                             <div class="row-col-1">                             
                             </div>
                             <div class="row-col-2" style="padding-left:140px; padding-top:20px;display:none; " >
                             <input  id="btnReset"  type="button"  class="srch-btn-home"  value="Reset"/>
                             </div>   
                              <div class="clear" style="margin-bottom:55px;">
                             </div>   
